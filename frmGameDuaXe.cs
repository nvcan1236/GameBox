...
namespace BaiTapLon_GameBox
{
    public partial class frmDuaXe : Form
    {
        ...
        public frmDuaXe(frmMain parent)
        {
            this.parent = parent;
            InitializeComponent();
            ResetGame();
        ...
        {
            parent.setHistory("Game Đua Xe", score);
            playSound();
            gameTimer.Stop();
        ...
        {
            System.Media.SoundPlayer playCrash = new System.Media.SoundPlayer(Application.StartupPath + @"/hit.wav");
            playCrash.Play();
        }
    }
}
